...
|-----------|------------|------------|
| ![Schematic]([schematic.png](https://github.com/ramuroy/AC-to-DC-Converter-PCB/blob/main/Images/Screenshot%20(6).png)) | ![PCB](Images/pcb_layout.png) | ![3D](Images/3d_render.png) |
